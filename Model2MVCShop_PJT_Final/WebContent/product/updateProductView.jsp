...
function fncAddProduct(){
	...
	document.detailForm.action='/updateProduct.do?tranCode=${tranCode}&menu=${menu}';
...
<table width="100%" border="0" cellspacing="0" cellpadding="0" style="margin-top: 13px;">
		...
		<td class="ct_write01">
			...
			<input type="text" readonly="readonly" name="manuDate" value="${prodVO.manuDate}" 	
						...
						<img 	src="../images/ct_icon_date.gif" width="15" height="15" 
									onclick="popUpCalendar(this,manuDate,'yyyy-mm-dd')" />
		</td>
	</tr>
	<tr>
		<td height="1" colspan="3" bgcolor="D6D6D6"></td>
	...
	<tr>
		...
		<td class="ct_write01">
			<%-- /////////////////////// EL / JSTL 적용으로 주석 처리 ////////////////////////
			<input	type="file" name="<%= prodVO.getFileName() %>" class="ct_input_g" 
						style="width: 200px; height: 19px" maxLength="13" value="null"/>
			/////////////////////// EL / JSTL 적용으로 주석 처리 //////////////////////// --%>
			<input	type="file" name="${prodVO.fileName}" class="ct_input_g" 
						style="width: 200px; height: 19px" maxLength="13" value="null"/>
		</td>
	</tr>
	<tr>
