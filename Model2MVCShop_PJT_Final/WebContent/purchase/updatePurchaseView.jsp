...
<script type="text/javascript" src="../javascript/popupcalendar.js">
</script>
...
<%-- /////////////////////// EL / JSTL 적용으로 주석 처리 ////////////////////////
 <form name="updatePurchase" method="post"	action="/updatePurchase.do?tranNo=<%=purchVO.getTranNo()%>">
/////////////////////// EL / JSTL 적용으로 주석 처리 //////////////////////// --%>
<form name="updatePurchase" method="post"	action="/updatePurchase.do?tranNo=${purchVO.tranNo}">
...
<table width="600" border="0" cellspacing="0" cellpadding="0"	align="center" style="margin-top: 13px;">
	...
	<tr>
		...
		<td class="ct_write01">
			...
			<%-- /////////////////////// EL / JSTL 적용으로 주석 처리 //////////////////////// 
							maxLength="20" value="<%=purchVO.getReceiverName()%>" />
			/////////////////////// EL / JSTL 적용으로 주석 처리 //////////////////////// --%>
							maxLength="20" value="${purchVO.receiverName}" />	
		</td>
	</tr>
	<tr>
		<td height="1" colspan="3" bgcolor="D6D6D6"></td>
	...
	<tr>
		...
		<td class="ct_write01">
			...
			<%-- /////////////////////// EL / JSTL 적용으로 주석 처리 //////////////////////// 
							maxLength="20" value="<%=purchVO.getReceiverPhone()%>" />
			/////////////////////// EL / JSTL 적용으로 주석 처리 //////////////////////// --%>
							maxLength="20" value="${purchVO.receiverPhone}" />
		</td>
	</tr>
	...
	<tr>
		...
		<td class="ct_write01">
			...
			<%-- /////////////////////// EL / JSTL 적용으로 주석 처리 //////////////////////// 
							maxLength="20" value="<%=purchVO.getDivyAddr()%>" />
			/////////////////////// EL / JSTL 적용으로 주석 처리 //////////////////////// --%>
							maxLength="20" value="${purchVO.divyAddr}" />
		</td>
	</tr>
	<tr>
		<td height="1" colspan="3" bgcolor="D6D6D6"></td>
	...
	<tr>
		...
		<td class="ct_write01">
			...
			<%-- /////////////////////// EL / JSTL 적용으로 주석 처리 //////////////////////// 
							maxLength="20" value="<%=purchVO.getDivyRequest()%>" />
			/////////////////////// EL / JSTL 적용으로 주석 처리 //////////////////////// --%>
							maxLength="20" value="${purchVO.divyRequest}" />
		</td>
	</tr>
	<tr>
		<td height="1" colspan="3" bgcolor="D6D6D6"></td>
		...
		<td width="200" class="ct_write01">
			<input type="text" readonly="readonly" name="divyDate" class="ct_input_g" 
				...
				<img 	src="../images/ct_icon_date.gif" width="15" height="15"	
							onclick="popUpCalendar(this, divyDate, 'yyyy-mm-dd');"/>
		</td>
	</tr>
	<tr>
		<td height="1" colspan="3" bgcolor="D6D6D6"></td>
	...
	<tr>
		...
		<table border="0" cellspacing="0" cellpadding="0">
			<tr>
				...
				<%-- /////////////////////// EL / JSTL 적용으로 주석 처리 ////////////////////////
					<!-- <a href="/updatePurchase.do?tranNo=<%=purchVO.getTranNo()%>">수정</a> -->
				/////////////////////// EL / JSTL 적용으로 주석 처리 //////////////////////// --%>
